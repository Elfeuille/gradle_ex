...
public interface TestTableMapper {
	...
	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table test_table
	 * @mbggenerated
	 */
	 ...
	 * @mbggenerated
	 */
	@Delete({"delete from test_table", "where id = #{id,jdbcType=INTEGER}"})
	 ...
	 * @mbggenerated
	 */
	@Insert({"insert into test_table (id, value)", "values (#{id,jdbcType=INTEGER}, #{value,jdbcType=VARCHAR})"})
	 ...
	 * @mbggenerated
	 */
	@Select({"select", "id, value", "from test_table", "where id = #{id,jdbcType=INTEGER}"})
	@Results({@Result(column = "id", property = "id", jdbcType = JdbcType.INTEGER, id = true),
			@Result(column = "value", property = "value", jdbcType = JdbcType.VARCHAR)})
	 ...
	 * @mbggenerated
	 */
	@Update({"update test_table", "set value = #{value,jdbcType=VARCHAR}", "where id = #{id,jdbcType=INTEGER}"})
